...
def options():
    ...
    while True:
        ...
        clock.tick(60)
        text1 = gameover_text_font.render('Key Controls:' , 1 , 'orange')
        text1_rect = text1.get_rect(center = (120 , 30))
        screen.blit(text1 , text1_rect)
        pg.draw.line(screen , 'orange' , (10 , 55) , (230 , 55) , 5)
        text2 = options_font1.render('W , S :  Player Movement' , 1  , 'orange')
        text2_rect = text2.get_rect(center = (170 , 80))
        screen.blit(text2 , text2_rect)
        text3 = options_font1.render('SPACE :  Fire Rat Poison', 1, 'orange')
        text3_rect = text3.get_rect(center = (165, 120))
        screen.blit(text3, text3_rect)
        text4 = options_font1.render('R :  Place Poison Traps', 1, 'orange')
        text4_rect = text4.get_rect(center = (160, 160))
        screen.blit(text4, text4_rect)
        text5 = options_font1.render('Press ESC to pause (obviously)', 1, 'orange')
        text5_rect = text5.get_rect(center=(210 , 200))
        screen.blit(text5, text5_rect)

        stage1 = gameover_text_font.render('Stage 1 (0-200):' , 1 , BLACK)
        stage1_rect = stage1.get_rect(center = (135 , 300))
        screen.blit(stage1 , stage1_rect)
        pg.draw.line(screen , BLACK , (10 , 325) , (260 , 325) , 5)
        stage1_text1 = options_font2.render('- Player moves slow' , 1 , BLACK)
        screen.blit(stage1_text1 , (10 , 330))
        stage1_text2 = options_font2.render('- Slow reload', 1, BLACK)
        screen.blit(stage1_text2 , (10 , 360))
        stage1_text3 = options_font2.render('- No poison traps(be careful)', 1, BLACK)
        screen.blit(stage1_text3, (10, 390))
        stage1_text4 = options_font2.render('- Slow & Few enemies', 1, BLACK)
        screen.blit(stage1_text4, (10, 420))

        stage2 = gameover_text_font.render('Stage 2 (200-600):' , 1 , BLACK)
        stage2_rect = stage2.get_rect(center = (505 , 300))
        screen.blit(stage2, stage2_rect)
        pg.draw.line(screen , BLACK , (360 , 325) , (660 , 325) , 5)
        stage2_text1 = options_font2.render('- Faster laser & trap reload', 1, BLACK)
        screen.blit(stage2_text1, (360, 330))
        stage2_text2 = options_font2.render('- More & Faster enemies', 1, BLACK)
        screen.blit(stage2_text2, (360, 360))
        stage2_text3 = options_font2.render('- Unlocks poison traps(1)', 1, BLACK)
        screen.blit(stage2_text3, (360, 390))


        stage3 = gameover_text_font.render('Stage 3 (600-1300):', 1, BLACK)
        stage3_rect = stage3.get_rect(center=(840, 300))
        screen.blit(stage3 , stage3_rect)
        pg.draw.line(screen, BLACK, (690 , 325), (998, 325), 5)
        stage3_text1 = options_font2.render('- Player moves faster', 1, BLACK)
        screen.blit(stage3_text1, (690, 330))
        stage3_text2 = options_font2.render('- Even faster reload', 1, BLACK)
        screen.blit(stage3_text2, (690, 360))
        stage3_text3 = options_font2.render('- +1 Poison trap(2)', 1, BLACK)
        screen.blit(stage3_text3, (690, 390))
        stage3_text4 = options_font2.render('- Even more & faster', 1, BLACK)
        screen.blit(stage3_text4, (690, 420))
        stage3_text5 = options_font2.render('enemies', 1, BLACK)
        screen.blit(stage3_text5, (690, 450))

        stage4 = gameover_text_font.render('Stage 4 (1300-2000):', 1, BLACK)
        stage4_rect = stage4.get_rect(center=(175 , 530))
        screen.blit(stage4, stage4_rect)
        pg.draw.line(screen, BLACK, (10 , 555) , (345 , 555), 5)
        stage4_text1 = options_font2.render('- Even MORE & FASTER enemies', 1, BLACK)
        screen.blit(stage4_text1, (10 , 560))
        stage4_text2 = options_font2.render('- +2 Poison traps (4)', 1, BLACK)
        screen.blit(stage4_text2, (10, 590))

        stage5 = gameover_text_font.render('Stage 5 (2000 +):', 1, BLACK)
        stage5_rect = stage5.get_rect(center=(830 , 530))
        screen.blit(stage5, stage5_rect)
        pg.draw.line(screen, BLACK, (695, 555), (970, 555), 5)
        stage5_text1 = options_font2.render('- CRAZY FAST enemies', 1, BLACK)
